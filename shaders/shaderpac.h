#ifndef __SHADERPAC_H_
#define __SHADERPAC_H_

#include <string>

static const std::string squareVertexShaderSrcPac = R"(
#version 430 core
...
static const std::string squareFragmentShaderSrcPac = R"(
#version 430 core
